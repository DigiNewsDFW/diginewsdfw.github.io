const articles = [{
  ...
  description: '<p>Dallas startup Conversable has been acquired by LivePerson, a publicly traded company that boasts an artificial-intelligence powered conversational platform for consumer-facing brands.<p/><p>The artificial intelligence and automation development teams at Conversable, which uses conversational bot technology, or “chatbots,” to help companies communicate with consumers, will join Live Person\'s global product and technology organization. Lamm and Busey will serve LivePerson as part-time strategic advisors. Financial terms of the deal were not disclosed.</p><p>“In bringing together our companies, we are paving the way to intuitive and authentic brand conversations throughout the entire customer lifecycle,” Ben Lamm, co-founder and CEO of Conversable, said in a release. “These conversations arm businesses with a new level of customer understanding.”</p>',
